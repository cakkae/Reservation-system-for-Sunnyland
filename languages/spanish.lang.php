<?php
    ...
    ******************************************************************************/
    ...
    define("Saturday","S&agrave;bado");
    define("Sunday","Domingo");

    #index_small.php
    define("SML_PREV","Anterior");
    define("SML_NEXT","Siguiente");
    define("SML_D0","Do");
    define("SML_D1","Lu");
    define("SML_D2","Ma");
    define("SML_D3","Mi");
    ...
    # booking-nojs.php
    # General
    define("APPLICATION_TITLE","BookingWizz administraci&oacute;n");
    define("GENERIC_QUERY_FAIL","Oopsy, error occured when trying to execute query.");
    define("BOOKING_FRM_CONFIRMED","Confirmed");
    define("BOOKING_FRM_NOTCONFIRMED","Sin Confirmar");
    define("BOOKING_FRM_USERCANCELLED","Cancelado Usuario");
    define("BOOKING_FRM_CANCELLED","Cancelado");
    define("BOOKING_FRM_PAID", "Paid");
    define("NO_ACCESS","Usted no tiene acceso a esta p&aacute;gina");
    ...
    # admin-index.php
    define("ADMIN_WELCOME","Bienvenido a su back office BookingWizz");
    ...
    # admin.php
    define("ADMIN_LOG","Bienvenido a su back office BookingWizz");
    define("LOGIN_USERNAME","Usuario:");
    ...
    # bs-events-add.php
    define("BS_EVENT_ADD_TXT","In this section you can add a new event by filling out the fields correctly below.");
    ...
    define("EVENT_STR_TIME","Event start time can't be the same or higher than the event end time!");
    ...
    define("EVENT_END_RECURR","End Date of Recurring:");//(used multiple times)
...
define("EVENT_COLOR","Event Color");
    ...
    define("BS_SERV_TXT","In this section, you can add a service by filling out the fields correctly below. If you want to add a multi service, please click on the link Multi-Service.");
    ...
    define("AUTOCONFIRM","Auto Confirmation Free bookings:");
    define("AUTOCONFIRM_MSG","Auto Confirmation Free bookings");
    define("EMAIL_SETTINGS","Email notificaiton setting per service:");
    define("EMAIL_FROM_NAME","From Name:");
    define("EMAIL_FROM_EMAIL","From Email:");
    define("SHOW_IMG","Show event image (resized):");
    define("SHOW_SEATS","Show \"available seats\" for Events");
    ...
    define("BACK_RETURN","Back Return");
    ...
    define("REPEAT_MSG","Please make sure your reserved date to equals to actual recurring interval end. For example if recurring booking must end in 6 weeks from now, set \"date to\" to \"today+6 weeks\"");
     ...
     #bs-coupons-add.php
    define("TXT_COUPONS_STARTS","first");
    define("BS_COUPONS_TXT","In this section you can add your discount coupons.");
    define("TXT_COUPONS_ENDS","End");
    ...
    define("LABEL_COUPON_CALENDARS","Applicable Calendars");
    ...
    define("TXT_DAY_SRV_AVAILABILITY","Days Booking Availability");
...
define("THIS_DEFAULT_SERVICE", "This is default service ");
    ...
    define("EXPORT_TITLE2","In section, you Attendees export.");
    define("EXPORT_TITLE3","Time interval to export");
    define("EVENT_BOOKINGS","Event Bookings");
    define("BOOKINGS","Bookings");
    define("DAY_BOOKINGS","Day bookings");
