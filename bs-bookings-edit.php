 ...
 * #******************************************************************************/
    ...
    if ($_SESSION["logged_in"] != true) {
        ...
        $imeSlavljenika = (!empty($_REQUEST["$imeGodine"])) ? strip_tags(str_replace("'", "`", $_REQUEST["$imeGodine"])) : '';
        $brojGodine = (!empty($_REQUEST["$brojGodine"])) ? strip_tags(str_replace("'", "`", $_REQUEST["$brojGodine"])) : '';
        $phone = (!empty($_REQUEST["phone"])) ? strip_tags(str_replace("'", "`", $_REQUEST["phone"])) : '';
        ...
        $result = mysql_query($sSQL) or die("err: " . mysql_error() . $sSQL);
        $date = mysql_result($result, 0, 'reserveDateFrom');
            ...
            <div class="form-row">
                ...
                <div class="cell short">
                    <label><?php echo BOOKING_FRM_QTY;?></label>
                     <input type="text" name="qty" id="qty" value="<?php echo $qty?>" class="small1 left"
