        ...
        if (!empty($todelID)) {
            if ($demo === false) {
                ...
                ##################################################################################
                    ...
                    $result = mysql_query($sql) or die("oopsy, error when tryin to delete bs_schedule");

                    $sql = "DELETE FROM  bs_schedule_days WHERE idService='" . $toDelete . "'";
                    $result = mysql_query($sql) or die("oopsy, error when tryin to delete  bs_schedule_days");

                $sql = "DELETE FROM bs_services WHERE id='" . $toDelete . "'";
                $result = mysql_query($sql) or die("oopsy, error when tryin to delete service 1");

                $sql = "DELETE FROM bs_service_settings WHERE serviceId='" . $toDelete . "'";
                $result = mysql_query($sql) or die("oopsy, error when tryin to delete service settings 1");

                    $sql = "DELETE FROM bs_service_days_settings WHERE idService='" . $toDelete . "'";
                    $result = mysql_query($sql) or die("oopsy, error when tryin to delete service day settings 1");
