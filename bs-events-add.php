            ...
            if (strtotime($eventDate) < strtotime($eventDateEnd)) {
               $msg= EVENT_SUC_MSG;
                ...
                if (empty($id)) {
                    ...
                    $result = mysql_query($sql) or die("oopsy, error occured when tryin to create new event." . "<br>" . $sql . "<br>".mysql_error());
                    $id = mysql_insert_id();
                ...
                $result = mysql_query($sql) or die("oopsy, error occured when tryin to update event." . $sql . "<br>".mysql_error());
        ...
        <hr/>
         ...
         <div class="form-row adj_fit_to_685">
                    ...
                    <div class="dates-row">
                        ...
                        <input type="text" name="eventDate" id="eventDate" class="small left <?php echo $requiredFields['eventDate']?>"
                           value="<?php echo (!empty($eventDate) && $eventDate!='YYYY-MM-DD' ? date("Y-m-d", strtotime($eventDate)) : "YYYY-MM-DD")?>"/> 
                    ...
                    <div class="dates-row">
                        ...
                        <input type="text" name="eventDateEnd" id="eventDateEnd" class="small left <?php echo $requiredFields['eventDateEnd']?>"
                           value="<?php echo (!empty($eventDateEnd) && $eventDateEnd!='YYYY-MM-DD' ? date("Y-m-d", strtotime($eventDateEnd)) : "YYYY-MM-DD")?>"/>
                        <label><?php echo SYL_AT ?></label>
                        <div class="left">
                ...
                <div class="form-row">
                    <div class="cell short1">
                        ...
                        <div class="cell short1">
                            ...
                            <input type="text" name="entryFee" id="entryFee" value="<?php echo $entryFee ?>" class="small1 left"
                    ...
                    <div class="cell short1">
                        ...
                        <input type="text" name="deposit" id="deposit" value="<?php echo $deposit*100 ?>" class="small1 left"
                               onkeyup="noAlpha(this)"/>
                        <img src='images/info.png' border="0" class="left tipTip imgCenter"  title="<?php echo NUMB_PLZ ?>"/>
                    ...
                    <div class="cell medium3">
                            ...
                            <div class="valign"> 
                                <input type="radio" name="payment_required"
                                       ...
                                       <?php echo REC ?>
                                <input type="radio" name="payment_required"
                                       value="2" <?php echo $payment_required == "2" ? "checked" : "" ?> <?php
                ...
                <div class="form-row">
                    ...
                    <div class="disabled left">
                        ...
                        <div class="cell">
                            ...
                            <input type="text" name="recurringEndDate" id="recurringEndDate" class="small left"
                                   value="<?php echo (!empty($recurringEndDate)&&$recurringEndDate!="0000-00-00" ? date("Y-m-d", strtotime($recurringEndDate)) : "")?>"/>
                ...
                <div class="form-row">
                    <div class="cell half" style="width:380px;">
                            ...
                            <input type="radio" name="allow_multiple"
                                   value="1" <?php echo $allow_multiple == "1" ? "checked='checked'" : "" ?> />
                                   <?php echo MLTP_TCT_CSTM ?>
                            <input type="radio" name="allow_multiple"
                                   value="2" <?php echo $allow_multiple == "2" ? "checked='checked'" : "" ?> <?php
                    ...
                    <div class="cell short1">
                        ...
                        <label><?php echo MXM_TCT?></label> 
                           <input type="text" name="max_qty" id="max_qty" value="<?php echo $max_qty?>" class="small1 left"
                           onkeyup="noAlpha(this)"/>
