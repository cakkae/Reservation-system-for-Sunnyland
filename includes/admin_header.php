...
<title>Sunnyland | Admin area</title>
...
<?php if(IS_WP_PLUGIN!='1'){?>
    <div id="header">
    	<?php if($_SESSION["logged_in"] != true): ?>
				<div class="adj_left" >
					<a href="admin.php"><img src="images/sunnyLogo.png" border="0" style="width:180px; height:117px;"/></a>
				</div>
		...
		<div class="adj_row" >
				...
				<div class="adj_right" >
					...
					<li><a href="#" >Pomoć</a>
						...
						<ul class="ul_to_left">
							...
							<li><a href="http://lilium.ba/kontakt.php" target="_blank">Podrška</a></li>
						</ul>
						</div>
					</li>
					<li style="margin-left:3px;"><a href="bs-settings.php" >Admin</a>
						...
						<ul>	
							<li><a href="bs-settings.php" >Postavke</a></li>
							<li><a href="bs-logout.php" >Odjava</a></li>
						</ul>
						</div>
					</li>
					</ul>
			...
			<div class="adj_row adj_top_menu_2" >
				<div class="adj_right" >
					<ul>
						<li><a href="admin-index.php">Kontrolna ploča</a></li>
		                <li><a href="index.php" target="_blank">Kalendar</a></li>
		                <li><a href="bs-addons.php">Dodaci</a></li>
		            </ul>
				</div>
			</div><!-- emd top menu 2 -->
		</div>
