...
$(function(){
    $.fn.colorbox({inline:true,href:"#popup",overlayClose:false,onClosed:popUpClose})
...
function popUpClose(){
    console.log('close')
    console.log($("#_popup"))
     console.log($("#_popup").is(':checked'))
    if($("#_popup").is(':checked')){
        $.post("ajax/checkShowPopup.php",{show:false},function(data){});
    }
            ...
            <div class="padd">
                ...
                <div class="dashboard transactions">
                     ...
                     <?php
                        ...
                        $result = mysql_query($sql) or die("error getting transactions from db");
                        $odd = "odd";
                        if(mysql_num_rows($result)>0){?>
                     ...
                     &nbsp;<a href="bs-bookings.php">Pogledaj sve</a>
                      <?php }?>
                </div>
...
<div style="display: none">
    <div id="popup">
        ...
        <div class="cell left">
            <h2><?php echo HSP7 ?></h2>
            <a href="http://codecanyon.net/item/bookingwizz-credit-card-payments/2424321?ref=Convergine" target="_blank">Kreditna kartica</a><br />
            <a href="http://codecanyon.net/item/bookingwizz-for-wordpress/2602153?ref=Convergine" target="_blank">Wordpress</a>
            <a href="http://codecanyon.net/item/bookingwizz-sms-reminders/6593053?ref=Convergine" target="_blank">SMS</a>
        </div>
        <div class="cell left nomr">
            <h2><?php echo HSP8 ?></h2>
