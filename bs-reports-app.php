...
<div class="content_block">
        ...
        <div class="form-row">
            ...
            <div class="cell third">
                ...
                <select name="serviceID" class="select" id="serviceID" >
                    <?php
                    $sql = "SELECT * FROM bs_services WHERE type='t'";
                    $res = mysql_query($sql);
    ...
    <div class="bw-reports-wrapper" id="AppointmentsXY" >
    	<h3><?php echo REPORTS_8 ?> <span id="updateDateFrom" >DATE_1</span> to <span id="updateDateTo" >DATE_2</span> <?php echo REPORTS_9?> <span id="forService" >FOR_SERVICE</span></h3>
